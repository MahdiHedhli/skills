...
Anything still open after that, choose a reasonable default and note it in one line. Then
build (delegating as needed). The [[neckbeard]] ruleset governs *how* the code is written;
this skill governs *what* and *where*, decided **with** the user, before it starts.
